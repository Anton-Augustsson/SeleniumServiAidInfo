...
def GetInfo(ArticleNumber):
    ...
    try:
        ...
        search.send_keys(
            ArticleNumber)  # "4220437503")  # "8433 0564 38")#"4211603085 ")#""4220437503")#"4220 4375 03 ")#"4222 0443 00")#"8433 0564 39")#"8433 0564 38")
    ...
    try:
        InfoLink = driver.current_url
    except:
        InfoLink = ''
    try:
        ImageLink = driver.find_element_by_xpath(
            '/html/body/div/section[4]/div/section/div/section[2]/div/section/div/section[2]/section/img').get_attribute(
            'src')
    except:
        ImageLink = ''
    try:
